...
**🤖 הרץ אוטומטית כאשר:**
- המשתמש שואל: "האם המערכת תקינה?"
- המשתמש שואל: "יש בעיות במערכת?"
- המשתמש מדבר על שגיאות או בעיות
- לפני תחילת עבודה על המערכת (אם יש חשד לבעיה)
...
**🤖 הרץ אוטומטית כאשר:**
- המשתמש שואל: "יש מתווכים חדשים?"
- המשתמש שואל: "בדוק את הפוסטים"
- המשתמש מדבר על מתווכים שעברו מבעד לסינון
- המשתמש אומר "נתח את הדאטה" או "מה המצב?"
- המשתמש מדבר על עדכון broker_keywords
- אחרי שהמערכת רצה והוסיפה פוסטים חדשים
