...
🔁 משה כהן פרסם 15 פוסטים - אולי מתווך סמוי
💡 המלצה: בדוק את הפוסטים שלו ידנית
...
### **D. משתמשים חוזרים** 🔁 **חדש!**
- זיהוי משתמשים שמפרסמים הרבה פעמים (5+ פוסטים)
- אולי מתווכים סמויים שמתחזים לפרטיים
- דוגמה: "משה כהן" פרסם 12 פוסטים רלוונטיים
- **המלצה:** בדוק ידנית - אם זה מתווך הוסף את השם ל-`broker_keywords`

### **E. פוסטים שסווגו לא נכון** ⚠️
...
**כל הרצה של /tune-ai מריצה טסטים אוטומטיים תחילה!**

הטסטים בודקים:
- ✅ קיום כל הקבצים הנדרשים (tune_ai.py, config.json, ai_agents.py, database.py)
- ✅ מבנה DB תקין (טבלת posts, כל העמודות)
- ✅ זיהוי פוסטי מתווכים
- ✅ זיהוי יישובים לא רלוונטיים
- ✅ זיהוי ביטויי blacklist
- ✅ זיהוי פוסטים שסווגו לא נכון
- ✅ שלמות config.json (ערים, broker_keywords)

**אם טסט נכשל - הסקריפט לא ירוץ!**

דוגמת פלט טסטים:
```
🧪 Tune AI - Automated Tests
======================================================================
📁 בודק קיום קבצים...
  ✅ tune_ai.py קיים
  ✅ config.json קיים
...
4️⃣ משתמשים חוזרים (2):
   🔁 "משה כהן" - 12 פוסטים
   🔁 "יוסי לוי" - 8 פוסטים
   💡 בדוק ידנית - אם זה מתווך הוסף לbroker_keywords
