...
**NON_URBAN** - מושב/כפר/יישוב (לא עיר!)
- דירה/בית במושב, כפר, יישוב קהילתי, התנחלות וכו'
- **רק ערים גדולות רלוונטיות:** תל אביב, ירושלים, בני ברק, בית שמש, פתח תקווה, רמת גן
- **דוגמאות ספציפיות - סנן מיד:**
...
1. **מחיר (מחיר הדירה בלבד!)**: 
   ...
   2. **עיר:**
   - חפש עיר מפורשת: "בירושלים", "תל אביב", "חיפה", "בית שמש", "בני ברק"
   ...
   - **שימוש בשם קבוצה (קדימות ראשונה!):**
     * **אם שם הקבוצה מכיל עיר** (ירושלים, בית שמש, בני ברק, תל אביב וכו') **→ זו העיר!**
     ...
     * **חריג יחיד:** אם הפוסט מזכיר עיר אחרת **במפורש** → השתמש בעיר המפורשת
...
3. **מיקום (שכונה/רחוב) - קריטי!**
   ...
   **זיהוי שכונה מרחוב מרכזי (חשוב!):**
   ...
   - דוגמאות:
     ...
     * "רחוב דיזנגוף בתל אביב" → location: "דיזנגוף, רחוב דיזנגוף"
