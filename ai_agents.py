...
1. **מחיר (מחיר הדירה בלבד!)**: 
   ...
   - **שימוש בשם קבוצה (בזהירות!):**
     * אם יש שכונה/רחוב בפוסט שיכול להתאים לעיר של הקבוצה → הסק את העיר
     * דוגמה: קבוצה "דירות בירושלים", פוסט "רחוב יצחק בן צבי" → city: "ירושלים"
     * דוגמה: קבוצה "דירות בירושלים", פוסט "קטמון" → city: "ירושלים"
     * **אבל:** אם הפוסט מזכיר עיר אחרת או אזור שלא מתאים → אל תסיק מהקבוצה!
   - **אם אין עיר מפורשת ואין שכונה ידועה ואין רמז מהקבוצה → null**
