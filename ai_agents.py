...
- **יישובים קטנים - סנן מיד:**
  ...
  - "התנחלות Y" → NON_URBAN
- **שכונות ידועות - אלו רלוונטיות! ⚠️**
  - **ירושלים:** נחלאות, מאה שערים, גאולה, קטמון, רמות, תלפיות, ארנונה, פסגת זאב, גבעת שאול, קריית יובל, רוממה, בית וגן, **German Colony (גם אנגלית!)**
...
- **כלל זהב:** אם יש שם קבוצה/תוכן עם ירושלים/בית שמש/בני ברק/רמת גן/גבעתיים/אשדוד/מעלה אדומים → בדוק אם זו שכונה באותה עיר → RELEVANT
- **רק** אם יש מילות מפתח ברורות (מושב, יישוב, התנחלות, כפר) **ואין אזכור עיר רלוונטית** → NON_URBAN
