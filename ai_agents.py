...
- **שכונות ידועות - אלו רלוונטיות! ⚠️**
  - **ירושלים:** נחלאות, מאה שערים, גאולה, קטמון, רמות, תלפיות, ארנונה, פסגת זאב, גבעת שאול, קריית יובל, רוממה, בית וגן
...
→ category: "RELEVANT", is_broker: false, reason: "אדם פרטי (אין סימני תיווך)"
"""
