...
- ✅ חתימה עסקית: "נדל״ן JF", "Real Estate X", "נכסים פלוס", "מקסים נדל״ן"
...
→ category: "RELEVANT", is_broker: true, reason: "מתווך סמוי (חתימה: נדל״ן JF)"

✅ מתווך סמוי:
"💎 3 דירות חדשות בתל אביב! 🏠
Real Estate Plus | שירה 050-1234567"
→ category: "RELEVANT", is_broker: true, reason: "מתווך סמוי (מספר נכסים + Real Estate Plus)"
...
3. **מיקום (שכונה/רחוב) - קריטי!**
   ...
   **זיהוי שכונה מרחוב מרכזי (חשוב!):**
   ...
   - דוגמאות:
     * "רחוב סוקולוv בירושלים" → location: "גבעת שאול, רחוב סוקולוv"
